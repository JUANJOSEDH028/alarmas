...
# Widget para que el usuario cargue el archivo CSV
...
if uploaded_file is not None:
    ...
    try:
        data = pd.read_csv(
            uploaded_file,
            encoding='latin1',
            skiprows=5,  # Ajustar según el formato real de tu CSV
    ...
    # Filtrar filas que contengan fechas con formato dd-mm-yyyy
    ...
    # Filtrar filas que no tengan usuario
    data = data[
        data["Usuario"].notna() &
    ...
    # Opción de exportar datos filtrados
    ...
    # Mensaje si no se ha cargado ningún archivo
